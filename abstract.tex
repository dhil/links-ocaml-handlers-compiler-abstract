...
\lstdefinelanguage{Links}{% 
  ...
  emph={Comp,Bool,Int,Char,String,Choose,Return,Toss,Heads,Tails,Nothing,Just,Fail,Zero},
...
\begin{lstlisting}
sig choose : Comp({Choose:Bool |e}, Bool)
fun choose() { do Choose }
\end{lstlisting}
This declares an \emph{abstract computation} \lstinline$choose$, which invokes an
operation \lstinline$Choose$ using the \lstinline$do$ primitive.
The \lstinline$sig$ keyword begins a signature.
Links employs row typing to support extensible effect signature. Thus
\lstinline$e$ is an effect variable, which can be instantiated with
additional operations.

\paragraph{Linear handlers} \dots
\begin{lstlisting}
...
\paragraph{Multi-shot handlers} \dots
\begin{lstlisting}
...
\paragraph{Exception handlers} \dots
\begin{lstlisting}
