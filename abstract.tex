...
\begin{figure}
  \centering
  \includegraphics[scale=0.5]{infrastructure.eps}
  \caption{High-level overview of the compiler components.}\label{fig:infra-diagram}
\end{figure}
...
can be translated either into byte or native code.
%
...
\lstinline[style=ocaml]$effect$ begins an operation match. By default we implement every handler
as a multi-shot handler.
